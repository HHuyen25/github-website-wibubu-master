    ...
    if (!isset($_POST['csrf_token']) || !hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'])) {
        ...
        if ($email && $password) {
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                // Redirect to homepage for all roles (admin/staff panels not implemented yet)
                    ...
                    <div class="enhanced-demo-accounts">
                        ...
                        <div class="demo-grid">
                            <div class="demo-account-card">
                                <div class="demo-badge">Admin</div>
                                ...
                                <button class="quick-login-btn" onclick="quickLogin('admin@wibubu.com', 'admin123')">
                                    ⚡ Đăng nhập nhanh
                                </button>
                            </div>
                        </div>
